...
public class ValidaGato {
    ...
    public static boolean idadeValida(int idade) {
        // Idade válida: entre 0 e 25 anos (inclusive)
    ...
    public static boolean alturaValida(double altura) {
        // Altura válida: entre 0.1m e 1.20m (inclusive)
        return altura >= 0.1 && altura <= 1.20;
    }
    ...
    public static boolean validaRaca(String raca) {
        // Retorna false se o nome for nulo, vazio ou contiver dígitos
    ...
    public static String validaraca(String raca) {
        ...
        if (raca == null || raca.trim().isEmpty()) {
            return "Erro: A raca do gato não pode estar vazio!";
        // Verifica se o nome contém números usando regex
        } else if (raca.matches(".*\\d+.*")) {
            return "Erro: A nome do gato não pode conter números!";
        }
        // Retorna string vazia se o nome for válido
        return "";
    }
